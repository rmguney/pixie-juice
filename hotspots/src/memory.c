/*
 * WASM Memory Management - Self-contained C standard library for WASM
 */
...
// Memory pool for WASM - 16MB should be sufficient for image processing
static uint8_t memory_pool[16 * 1024 * 1024];
