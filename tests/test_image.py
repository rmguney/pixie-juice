...
async def run_comprehensive_test():
    ...
    async with async_playwright() as p:
        ...
        print("📝 Browser console logging initialized")
        ...
        try:
            ...
            test_cases = [
                ...
                # AVIF formats - using generated fixtures (NEW FORMAT SUPPORT)
                ("AVIF_Small", "fixtures/images/avif/small_avif.avif", 12),
                ("AVIF_Medium", "fixtures/images/avif/medium_avif.avif", 18),
                ("AVIF_Large", "fixtures/images/avif/large_avif.avif", 25),
                ("AVIF_Low_Small", "fixtures/images/avif/small_avif_low.avif", 8),
                ("AVIF_High_Medium", "fixtures/images/avif/medium_avif_high.avif", 22),
                ("AVIF_Lossless_Small", "fixtures/images/avif/small_avif_lossless.avif", 15),
                ("AVIF_Ultra", "fixtures/images/avif/ultra_avif.avif", 30),
            ...
            for format_name, fixture_path, expected_compression in available_test_cases:
                ...
                try:
                    ...
                    print(f"   📝 Console messages before upload: {pre_upload_console_count}")
                    ...
                    if post_upload_console_count > pre_upload_console_count:
                        print(f"   💬 Console activity during upload: {post_upload_console_count - pre_upload_console_count} new messages")
                    ...
                    if await optimize_btn.count() > 0:
                        ...
                        if post_optimization_console_count > pre_optimization_console_count:
                            print(f"   💬 Console activity during optimization: {post_optimization_console_count - pre_optimization_console_count} new messages")
