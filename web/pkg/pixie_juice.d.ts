...
export function optimize_avif(data: Uint8Array, quality: number): Uint8Array;
...
export function is_avif(data: Uint8Array): boolean;
...
export function convert_to_avif(data: Uint8Array, quality: number): Uint8Array;
