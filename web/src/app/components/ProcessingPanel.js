...
export default function ProcessingPanel({ files, wasm, onProcess, setIsProcessing }) {
  ...
  const [losslessMode, setLosslessMode] = useState(false); // Lossless mode toggle
    ...
    try {
      for (let i = 0; i < files.length; i++) {
        ...
        try {
          ...
          // 🔍 Enhanced diagnostic logging for problematic images
          ...
          // Log first few bytes to help identify file format issues
          ...
          // Add error tracking for compress_lz4 specifically
          const consoleLogs = [];
          ...
          try {
            ...
            // Enhanced file type detection for SVG and other formats
