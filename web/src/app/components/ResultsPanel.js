                    ...
                    <div className="space-y-1">
                      ...
                      {result.performanceMetrics && (
                        <div className="text-xs text-neutral-600">
                          Performance: {result.performanceMetrics.processing_time || 'N/A'}ms
                          {result.performanceMetrics.memory_usage && 
                            ` | Memory: ${(result.performanceMetrics.memory_usage / 1024 / 1024).toFixed(1)}MB`
                          }
                        </div>
                      )}
                    </div>
