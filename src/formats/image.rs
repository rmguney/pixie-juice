...
mod tests {
    ...
    fn test_format_from_extension() {
        assert_eq!(ImageFormat::from_extension(&PathBuf::from("test.png")).unwrap(), ImageFormat::Png);
        assert_eq!(ImageFormat::from_extension(&PathBuf::from("test.jpg")).unwrap(), ImageFormat::Jpeg);
        assert_eq!(ImageFormat::from_extension(&PathBuf::from("test.jpeg")).unwrap(), ImageFormat::Jpeg);
        assert_eq!(ImageFormat::from_extension(&PathBuf::from("test.webp")).unwrap(), ImageFormat::WebP);
        
        assert!(ImageFormat::from_extension(&PathBuf::from("test.unknown")).is_err());
    }
