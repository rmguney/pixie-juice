//! Core types and data structures for Pixie Juice high-performance media processing
//! 
//! This module defines the fundamental types used throughout the library,
//! including configurations, results, and data structures optimized for WebAssembly
