//! WASM-optimized configuration for Pixie Juice high-performance media processing
//! 
//! This module provides browser-optimized configuration structures with
//! C hotspot integration and performance monitoring capabilities.
